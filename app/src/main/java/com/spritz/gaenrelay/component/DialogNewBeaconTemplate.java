...
package com.spritz.gaenrelay.component;
...
public class DialogNewBeaconTemplate extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView immunibeaconChoice = (TextView)contentView.findViewById(R.id.newbeacon_textview_immunibeacon);
        immunibeaconChoice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityBeaconEdit.createNewBeacon(getActivity(), BeaconType.immunibeacon);
                dismiss();
            }
        });
        return contentView;
