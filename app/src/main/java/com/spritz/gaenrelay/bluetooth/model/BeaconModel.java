...
package com.spritz.gaenrelay.bluetooth.model;
...
import com.spritz.gaenrelay.bluetooth.AdvertiseDataGenerator;
import com.spritz.gaenrelay.bluetooth.ExtendedAdvertiseData;
...
public class BeaconModel implements Parcelable {
    ...
    private ImmuniBeacon immunibeacon;
    ...
    public BeaconModel(BeaconType type) {
        ...
        switch (type) {
            ...
            case altbeacon:
                ...
                break;
            case immunibeacon:
                this.immunibeacon = new ImmuniBeacon();
                break;
            default:
    ...
    public AltBeacon getAltbeacon() { return altbeacon; }

    public void setAltBeacon(AltBeacon altbeacon) {
        this.altbeacon = altbeacon;
    }

    public ImmuniBeacon getImmunibeacon() { return immunibeacon; }

    public void setImmuniBeacon(ImmuniBeacon immunibeacon) {
        this.immunibeacon = immunibeacon;
    }

    public String getBleMacAddress() { return blemac; }

    public void setBleMacAddress(String blemac) {
        this.blemac = blemac;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.immunibeacon, flags);
    }
    ...
    protected BeaconModel(Parcel in) {
        ...
        this.immunibeacon = in.readParcelable(ImmuniBeacon.class.getClassLoader());
    }
